...
const InstantDocumentPreview: React.FC<InstantDocumentPreviewProps> = ({
  file,
  fileId,
  fileName,
  ...
  const [showPreview, setShowPreview] = useState(showInstantPreview);
  ...
  // Auto-show preview when showInstantPreview is true
  useEffect(() => {
    setShowPreview(showInstantPreview);
  }, [showInstantPreview]);
